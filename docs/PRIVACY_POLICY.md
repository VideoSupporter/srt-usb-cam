# Privacy Policy for SRT USB Camera Transmitter

**Last Updated: May 9, 2026**

## Introduction

This Privacy Policy describes how SRT USB Camera Transmitter ("we", "our", or "the application") handles user information. We are committed to protecting your privacy and being transparent about the application's data practices.

## Information Collection

**SRT USB Camera Transmitter does not collect, transmit, or store personal information for analytics, tracking, advertising, or profiling.**
...
SRT USB Camera Transmitter may store the following data locally on your computer:
...
SRT USB Camera Transmitter sends video by:
...
SRT USB Camera Transmitter does not integrate with or use third-party analytics, tracking, or advertising services.
...
SRT USB Camera Transmitter does not knowingly collect any information from anyone, including children under the age of 13.
...
As SRT USB Camera Transmitter does not collect personal information, there is no personal data held by us to:
...
SRT USB Camera Transmitter is designed to keep settings and logs local. Camera video is sent only to the SRT destination configured by the user.

---

**SRT USB Camera Transmitter Team**
May 9, 2026
